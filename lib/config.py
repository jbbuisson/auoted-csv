...
class Config:
    """Config objects hold the rules that need to be applied to input files"""
    rules = {}
    ...
    def get_rule(self, filename: str) -> Rule:
        ...
        Raise Exception when filename does not match any rule
        """
    ...
    def _check_parameter(parameters: dict, filename_pattern: str, key: str) -> bool:
        """
        Check if a parameter is a key in the parameters dictionary
        Raise Exception when key is not found in the dictionary
        """
